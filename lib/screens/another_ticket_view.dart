        ...
        child: Column(
          ...
          children: [
            ...
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    SizedBox(width: 100, child: Text("Santo Illeso", style: Styles.headlineText4.copyWith(color: Colors.white),),),
                     Text("80H 30M", style: Styles.headlineText4.copyWith(color: Colors.white),),
                    SizedBox(width: 100, child: Text("El Passo", textAlign: TextAlign.end, style: Styles.headlineText4.copyWith(color: Colors.white),),),
                  ],),
                    ...
                    child: LayoutBuilder(
                      builder:
                        ...
                        return Flex(
                          direction: Axis.horizontal,
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: List.generate((constraints.constrainWidth()/15).floor(),(index) => const SizedBox(width: 3, height: 1,
                          child: DecoratedBox(decoration: BoxDecoration(color: Colors.white)),
                          ),
                          ),
                        );
